"""
🧪 COMPREHENSIVE TEST SUITE - UPDATED FOR WINDOWS
Precision Agriculture System - All Components Test
Tests all 6 models + Report Generation + XAI + Balaramaji Assistant
...
- ✅ Auto-creates test_results directory

This script:
1. Tests each model independently
2. Saves results to timestamped text file
...
class TestResults:
    ...
    def __init__(self):
        ...
        self.output_lines = []  # Store output for file writing
    ...
    def print_summary(self):
        ...
        self.print_and_save(f"⏭️  Skipped: {self.results['skipped']}")
        ...
        try:
            ...
            with open(filepath, 'w', encoding='utf-8') as f:
                ...
                for line in self.output_lines:
                    # Remove emoji if they cause encoding issues
                    try:
                        f.write(line + "\n")
...
class PrecisionAgricultureTester:
    ...
    # Model test methods (abbreviated for length - refer to full version)
    def test_disease_detection(self):
        ...
        try:
            ...
            try:
                ...
                self.results.add_test("Disease Detector - Initialization", "passed", "Model loaded successfully")
            ...
            try:
                ...
                self.results.print_and_save(f"PASSED: Model Info - {info['num_classes']} classes")
            except Exception as e:
            ...
            try:
                ...
                self.results.print_and_save(f"PASSED: {len(crops)} supported crops")
            except Exception as e:
            ...
            self.results.print_and_save("SKIPPED: Image Prediction (requires image file)")
            
        except ImportError as e:
            self.results.add_test("Disease Detector - Import", "failed", error=str(e))
            self.results.print_and_save(f"FAILED: Import Error - {str(e)}")
    ...
    def test_weather_service(self):
        ...
        try:
            ...
            try:
                ...
                self.results.print_and_save("PASSED: Service Initialization")
            except Exception as e:
            ...
            try:
                ...
                self.results.add_test("Weather Service - Location Search", "passed", f"Found {len(locations)} locations")
            ...
            try:
                ...
                self.results.print_and_save("PASSED: Weather Data Retrieved")
            except Exception as e:
    ...
    def test_soil_analyzer(self):
        ...
        try:
            ...
            try:
                ...
                self.results.print_and_save("PASSED: Analyzer Initialization")
            except Exception as e:
    ...
    def test_yield_predictor(self):
        ...
        self.results.print_and_save("\n" + "=" * 80)
        self.results.print_and_save("TESTING MODEL 4: YIELD PREDICTOR")
        self.results.print_and_save("=" * 80)
        ...
        try:
            ...
            try:
                ...
                self.results.print_and_save("PASSED: Predictor Initialization")
            except Exception as e:
            ...
            try:
                test_data = self.test_data["yield"]["with_history"]
                result = predictor.predict(**test_data)
                self.results.add_test("Yield Predictor - With History", "passed", f"Yield: {result['predicted_average_yield']} kg/ha")
                self.results.print_and_save(f"PASSED: Predicted={result['predicted_average_yield']} kg/ha")
            except Exception as e:
                self.results.add_test("Yield Predictor - With History", "failed", error=str(e))
                self.results.print_and_save(f"FAILED: {str(e)}")
    ...
    def test_irrigation_optimizer(self):
        ...
        try:
            ...
            try:
                ...
                self.results.print_and_save("PASSED: Optimizer Initialization")
            except Exception as e:
    ...
    def test_pest_risk_assessor(self):
        ...
        try:
            ...
            try:
                ...
                self.results.print_and_save("PASSED: Assessor Initialization")
            except Exception as e:
    ...
    def test_report_generator(self):
        ...
        try:
            ...
            try:
                ...
                self.results.print_and_save("PASSED: Generator Initialization")
            except Exception as e:
            ...
            try:
                ...
                self.results.print_and_save(f"PASSED: Generated {len(report)} characters")
            except Exception as e:
    ...
    def test_explainability(self):
        ...
        try:
            ...
            try:
                ...
                self.results.print_and_save("PASSED: Explainer Initialization")
            except Exception as e:
    ...
    def test_balaramaji_assistant(self):
        ...
        try:
            ...
            try:
                ...
                self.results.print_and_save("PASSED: Assistant Initialization")
            except Exception as e:
